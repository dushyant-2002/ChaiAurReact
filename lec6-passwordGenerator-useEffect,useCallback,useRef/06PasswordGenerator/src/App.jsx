...
const passwordRef = useRef(null);
  ...
  const copyPasswordToClipboard = useCallback(()=>{
    ...
    // passwordRef.current?.setSelectionRange(2,9);//used to select value from 2 to 9 pos.can be used in other projects
  ...
  return (
    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-2 my-8 text-orange-500 bg-gray-700 text-white'>
    ...
    <div className='flex text-sm gap-x-2'>
      ...
      <div className='flex items-center gap-x-1'>
        ...
        />
        <label htmlFor="charInput">SpecialChars</label>
      </div>  
    </div>
    </div>
